...
// --- IMPORT ASSETS (Ganti dengan path yang benar di proyek Anda) ---
// Asumsi ini adalah path yang Anda gunakan di folder src/assets
import LogoImage from './assets/gemini-logo-removebg-preview-2.png'; 
import MainImage1 from './assets/image-13.jpg'; // Menggunakan gambar spesifik dari desain Anda

// --- MOCK DATA (Data statis dari konten HTML Anda) ---
const kegiatanLengkap = [
    { 
        id: 1, // ID ini harus cocok dengan ID yang dikirim dari halaman daftar
    ...
    // Tambahkan data kegiatan lain di sini (id: 2, id: 3, dst.)
];

const VolunteerDetailProgram = () => {
    // Mengambil ID dari URL
    const { id } = useParams();
    // Mencari data yang sesuai (misalnya, kita asumsikan ID 1)
    // Dalam implementasi nyata, Anda harus menggunakan parseInt(id)
    ...
    return (
        <div className="detail-page-wrapper">
            ...
            {/* --- KONTEN UTAMA (Menggantikan .frame-21 body) --- */}
            <div className="content-area">
                ...
                {/* Detail Data Kegiatan (Menggantikan Kotak-kotak Kaku) */}
                ...
                {/* Tombol Kembali (Menggantikan .rectangle-21 dan .kembali) */}
